...
<body>
 <div id="bbswrite_wrap">
  ...
  <form method="post" action="board_update_ok.do" onSubmit="return board_check()">
   ...
   <table id="bbswrite_t">
    <tr>
     <th>글쓴이</th>
     <td>
     <input name="board_name" id="board_name" size="14" class="input_box" value="${board.board_name}"/>
     </td>
    </tr>
    <tr>
     <th>비밀번호</th>
