...
$(document).ready(function(){
	$("#email option[value='${member.domain}']").prop('selected',true);
	$("#phone1 option[value='${member.phone1}']").prop('selected',true);
	$("input:radio[name='gender'][value='${member.gender}']").prop('checked',true);
	<c:forEach var="h" items="${hobby}">
		$("input:checkbox[name='hobby'][value='${h}']").prop('checked',true);
	</c:forEach>
});
</script>
...
<table border=1 width=500 align=center>
	...
	<tr><td>ID</td>
		<td>
			<input type=text autofocus="autofocus" id="id" name="id" value="${member.id}" readonly>
		</td>
	</tr>
	<tr><td>비밀번호</td>
