...
<table cellpadding="0" cellspacing="0" align=center border=1>
	...
	<tr>
		...
		<td>
			<input type="text" name="board_name" id="board_name" size="10" maxlength="10" value="${board.board_name}">
		</td>
	</tr>
	<tr>
		<td style="font-family:돋음; font-size:12" height="16">
	...
	<tr>
		...
		<td>
			<input type="text" name="board_subject" id="board_subject" size="50" maxlength="100" value="${board.board_subject}"> 
		</td>
	</tr>
	<tr>
